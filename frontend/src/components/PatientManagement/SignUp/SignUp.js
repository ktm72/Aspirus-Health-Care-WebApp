...
function SignUp() {
    ...
    async function Register(event){
        ...
        if(password === confirmpassword){
            ...
            try {
                await axios.post("http://localhost:8070/patient/signup",newPatient);
                    ...
                    <form onSubmit={Register} class="boxSignUp">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-4">
                                <div class="form-group">
                                    <OutlinedInput 
                                        type="date" id="dob" required fullWidth
                            ...
                            <div class="col-md-6 mb-4">
                                <div class="form-group">
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input 
                                            class="form-check-input" type="radio" name="gender" id="female" value="Female" required
                                            onChange={(event)=> {setGender(event.target.value)}}
                                        />
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <OutlinedInput 
                                        ...
                                        id="password" placeholder="Password" required fullWidth
                            ...
                            <div class="col-md-6 mb-4">
                                <div class="form-group">
                                    <OutlinedInput 
                                        type={showPassword ? "text" : "password"}
                                        id="confirmpassword" placeholder="Confirm Password" required fullWidth
